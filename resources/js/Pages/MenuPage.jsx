...
const MenuPage = () =>{
    const {products: productCategory, getMenu} = useHomeStore();
                ...
                <div>
                   {Object.entries(productCategory).map(([category, products]) =>(
                        <div key={category} className="w-full">
                            ...
                            <div className="w-full flex gap-10 flex-wrap px-10">
                                {products.map((product) =>(
                                    <div 
                                        key={product.id} 
                                        className="relative card bg-base-100 w-full sm:w-60 h-62  shadow-sm overflow-hidden group">
                                        <div 
